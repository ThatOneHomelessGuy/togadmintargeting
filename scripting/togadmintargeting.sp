...
public Plugin:myinfo =
{
	...
	author = "That One Guy",
	description = "Adds @admins and @!admins targeting methods based on flag 'b'",
...
{
	CreateConVar("togadmintargeting_version", PLUGIN_VERSION, "TOG Admin Targeting: Version", FCVAR_NOTIFY|FCVAR_DONTRECORD);
